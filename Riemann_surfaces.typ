...
#proof[
  ...
  this chart. Note that $U sect G$ is a nonempty open set containing $b$. By the identity theorem for holomorphic functions, we have $F_1=F_2$ on $phi(U)$. Thus $f_1|_U=f_2|_U$ on $U$. Hence $b in G$ and $G$ is closed. Now since $X$ is connected,
]
