...
== Divisor <divisor>
#block[
  Divisor Group Let $X$ be a Riemann surface. The #strong[divisor group] of $X$ is the free abelian group generated by the
  points of $X$, denoted by $"Div" lr((X))$. An element of $"Div" lr((X))$ is called a #strong[divisor] on $X$. A divisor $D$ on $X$ can
